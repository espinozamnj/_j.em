(function () {
    ...
    // dir_project
    let icons = create('script', [['src', jso + '_j.em/off/save/js/all-fa.js']], document.head)
    ...
    let actions = [
        ...
        ['play','play',function(){let vd=getVID();if(getVID().paused){vd.play();me.b.children[6].innerHTML='<i class="fas fa-pause"></i>'}else{vd.pause();me.b.children[6].innerHTML='<i class="fas fa-play"></i>'}}],
