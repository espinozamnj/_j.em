JSONViewer = (function () {
    ...
    JSONViewer.prototype._createSimple = function (value) {
        ...
        if (type === "string") {
            ...
            let str_a = !window.json_separator_str[0] ? '"' : window.json_separator_str[0]
            let str_z = !window.json_separator_str[1] ? '"' : window.json_separator_str[1]
            txt = str_a + value + str_z
        } else if (value === null) {
            type = "null"
            txt = "null"
