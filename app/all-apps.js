const __apps__ = [
    ...
    {name: 'View marks', fav: 'chrome', url: '@links/chrome', sec: false},
    {name: 'Extensions', fav: 'chrome', url: '@off/save/extensions', sec: false},
    {name: 'Bookmarks', fav: 'marks', url: '@links/bookmaps', sec: true},
    // {name: 'members', fav: 'xampp', url: '#', sec: false},
    // {name: 'adm_db', fav: 'xampp', url: '#', sec: false},
    ...
    {name: 'Black screen', fav: 'wait-room', url: '@off/mp4/wait.html', sec: false},
    {name: 'Tech Apps', fav: 'tech', url: '@links/tech', sec: false},
    {name: 'Nihan', fav: 'nihan', url: 'https://v-etoski.web.app/nihan/', sec: false},
    {name: 'Music', fav: 'music', url: 'https://spain-bash.github.io/music-private/', sec: true},
]